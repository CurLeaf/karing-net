...
```bash
python3 /home/yxw/Projects/karing-net/linux/sync_rules.py apply
python3 /home/yxw/Projects/karing-net/linux/sync_rules.py check
```
...
```bash
python3 /home/yxw/Projects/karing-net/linux/selfcheck.py           # 全量：线路 + DNS + 内核 + 回收器状态（只读，约 70 秒）
python3 /home/yxw/Projects/karing-net/linux/sync_rules.py check    # 规则是否都在
python3 /home/yxw/Projects/karing-net/linux/karing-reconcile.py --once --dry-run
...
```bash
bash /home/yxw/Projects/karing-net/linux/tests/run_tests.sh
```
